...
Revision ID: e046a9d682f2
Revises: 
Create Date: 2025-11-28 21:01:46.466766
...
def upgrade():
    ...
    with op.batch_alter_table('alunos', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_alunos_username'), ['username'], unique=True)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('alunos', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_alunos_username'))
